...
def generate_latex():
    ...
    response = client.chat.completions.create(
        ...
        messages=[
            ...
            {
                "role": "user",
                "content": r"""Can you generate latex code for a sample resume?
The Rules are:
- Strictly follow the given format.
- Do not include ``` and ```latex
- Only give the latex code and say nothing else
